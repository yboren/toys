...
login_url = 'https://www.v2ex.com/signin'  # 如V2EX设置了使用 SSL,必须改https
index_url = 'https://www.v2ex.com'  # 同上
mission_url = 'https://www.v2ex.com/mission/daily'  # 同上
...
def try_login(url):
    ...
    resp = v2ex_session.post(url, data=post_info,
